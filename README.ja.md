...
| 人間向けのドキュメント | 基本的に韓国語および英語をサポート、必要に応じて日本語をサポート |
...
ドキュメント作成言語は、[BLUEPRINT.mdのLanguage Policy](./BLUEPRINT.md#language-policy)に従います。ユーザー向けの概要ドキュメントは韓国語および英語で基本的に提供し、必要に応じて日本語を追加できますが、ルール、ポリシー、技術ガイドライン、およびAI指示書は英語のみで記述します。
