...
| 사람을 위한 문서 | 한국어 및 영어 기본 지원, 필요시 일본어 지원 |
| 룰 및 거버넌스 문서 | 영어로만 제공 |
...
문서 작성 언어는 [BLUEPRINT.md의 Language Policy](./BLUEPRINT.md#language-policy)를 따릅니다. 사용자를 위한 개요 문서는 한국어 및 영어로 기본 제공하며 필요에 따라 일본어를 가미할 수 있으나, 규칙, 정책, 기술 지침서 및 AI 지침은 영어로만 일관되게 기재합니다.
