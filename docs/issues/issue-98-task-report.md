...
PR [#99](https://github.com/Soku-JINSEOK/Soku-Convention-Boilerplate/pull/99)
contains the manual, discovery links, baseline correction, documentation
contract test, and repository-hygiene integration. Its initial hosted code and
metadata runs passed.
...
- `scripts/ci-local.sh --workspace .` — environment preflight stopped because
  ...
  Validation supplied the clean-environment result
- Hosted repository, runtime-template, and security Validation — passed
  ([run 29974297814](https://github.com/Soku-JINSEOK/Soku-Convention-Boilerplate/actions/runs/29974297814))
- Hosted metadata Validation — passed
  ([run 29974297924](https://github.com/Soku-JINSEOK/Soku-Convention-Boilerplate/actions/runs/29974297924))
- Hosted CodeQL matrix — passed
  ([run 29974296051](https://github.com/Soku-JINSEOK/Soku-Convention-Boilerplate/actions/runs/29974296051))
...
PR [#99](https://github.com/Soku-JINSEOK/Soku-Convention-Boilerplate/pull/99)에
매뉴얼, 발견 링크, baseline 수정, 문서 계약 테스트와 repository-hygiene 연결을
구현했습니다. 최초 hosted 코드·metadata 실행이 통과했습니다.
...
- `scripts/ci-local.sh --workspace .` — 로컬 `shellcheck` 미설치로 환경 preflight에서
  중단; 위 targeted 검사는 통과했고 hosted Validation이 clean-environment 결과 제공
- hosted repository, runtime-template, security Validation — 통과
  ([run 29974297814](https://github.com/Soku-JINSEOK/Soku-Convention-Boilerplate/actions/runs/29974297814))
- hosted metadata Validation — 통과
  ([run 29974297924](https://github.com/Soku-JINSEOK/Soku-Convention-Boilerplate/actions/runs/29974297924))
